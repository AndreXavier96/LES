...
urlpatterns = [
    ...
    path("consultar_utilizadores/apagar_utilizadores/<int:pk>/", Apagar_user.as_view(), name='apagar_user'),
            ...
            # Password reset links (ref: https://github.com/django/django/blob/master/django/contrib/auth/views.py)S
     ...
     path('password_change/', auth_views.PasswordChangeView.as_view(template_name='registration/password_change.html', success_url=reverse_lazy('Utilizadores:password_change_done1')), name='password_change'),
    ...
    #success_url = reverse_lazy('Utilizadores:password_change_done1')
