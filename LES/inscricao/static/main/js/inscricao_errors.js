function validateForm(this_id, participante) {
    ...
    } else if (participante === 'Participante em Grupo' && !RegExp("^[a-zA-Z]+$").test(p)) {
    ...
    } else if (escola === "others" && !RegExp('^[A-zÀ-ÿ ]+$').test(nome)) {
    ...
    } else if (escola === "others" && !RegExp('^[A-zÀ-ÿ ]$').test(localidade)) {
